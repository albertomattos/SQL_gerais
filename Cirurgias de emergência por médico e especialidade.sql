SELECT NOME_PRO, faespcad.descricao,
count(nome_pro)
...
and BLCIRU_REALIZADA.Fk_Carater_Atend = '2'
AND BLPROC_CIRURGICO.DATA_HORA_INI >= '01/01/2017' AND BLPROC_CIRURGICO.DATA_HORA_INI <= '31/01/2017'
