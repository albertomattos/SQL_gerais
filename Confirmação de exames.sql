select t.*, t.rowid from ITENS_PED_PROCED t where t.confirmado = 'N' and num_pedido = '0001680776'
--update itens_ped_proced set confirmado = 'S' where confirmado = 'N' and num_pedido = '0001234894'

update itens_ped_proced set dh_canc_pedido = sysdate - 1
  ...
  and i.cod_prd = j.codigo and i.confirmado = 'N' and i.dh_canc_pedido is null and i.comanda IS NULL
  and j.tipo_prd = 'TOM')
  and h.tipo_prd = 'TOM' and f.confirmado = 'N' and g.data_hora <= sysdate - 2 and f.comanda IS NULL)
  and a.confirmado = 'N' and a.cod_prd in (select codigo from faprdcad where tipo_prd = 'TOM')
  and a.comanda IS NULL) and cod_prd in (select codigo from faprdcad where tipo_prd = 'TOM'
  and comanda IS NULL and confirmado = 'N') and num_pedido = '0000036572';
