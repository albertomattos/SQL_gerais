SELECT faprdcad.co_tuss, faprdcad.descricao,faespcad.descricao, count(faprdcad.descricao)
...
AND BLPROC_CIRURGICO.DATA_HORA_INI >= '01/07/2016' AND BLPROC_CIRURGICO.DATA_HORA_INI <= '28/10/2016'
--and faprocad.cod_pro = '000933'
group by faprdcad.co_tuss, faprdcad.descricao, faespcad.descricao
