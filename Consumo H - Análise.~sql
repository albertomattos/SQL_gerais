SELECT FA_PRT.NOME_PAC, FA_PAC.COD_PAC, FA_TIP.TIPO_PRD, FA_TIP.PRE_CLASS, FA_PRD.CODIGO, DECODE(MOVDES.SEQUENCIAL_PCT, '',
...
AND FA_TIP.PRE_CLASS <> 'KIT' AND MOVDES.DESTINO = 'H' AND MOVDES.SEQUENCIAL_PCT IS NULL
AND FA_MOC.DATA_MOV >= TO_DATE('01/01/2017','DD/MM/YYYY')
AND FA_MOC.DATA_MOV <= TO_DATE('31/01/2017','DD/MM/YYYY') AND FA_PAC.TIPO_PAC IN ('A','I','U','E') ORDER BY 25, 24, 23, 3, 1, 2, 6
