...
delete from historico_custo;
INSERT INTO HISTORICO_CUSTO SELECT COD_PRD, MAX(ANO_MES) FROM ESHISCUS WHERE ANO_MES <= '201303' GROUP BY COD_PRD;
...
AND ESHISCON.COD_UNI = '      ' AND ESHISCON.ANO_MES = '201203'
