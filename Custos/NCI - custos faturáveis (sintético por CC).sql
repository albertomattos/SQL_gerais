...
where /*b.ano_mes >= '201504' and b.ano_mes <= '201504'
 ...
 and a.cod_cliente = '0135'
  and b.cod_cus in ('00018','00019','00020','00021','00022','00024','00025','00026','00027','00036','00096','00097') --Itens faturáveis
...
where /*b.ano_mes >= '201504' and b.ano_mes <= '201504'
  ...
  and c.cod_cus = d.cod_cus
  and a.cod_cliente = '0135'
  and b.cod_cus in ('00018','00019','00020','00021','00022','00024','00025','00026','00027','00036','00096','00097')
group by b.ano_mes, a.descricao
)
