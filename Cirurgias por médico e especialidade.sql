SELECT NOME_PRO, faespcad.descricao,count(nome_pro)
...
and BLPROC_CIRURGICO.PROC_PRINCIPAL = 'S'
and faesppro.sn_principal = 'S' AND  BLEQPE_PROC_CIRU.COD_ATO IN ('01') AND  BLCIRU_STATUS.CD_CIRU_STATUS = 'E'
AND BLPROC_CIRURGICO.DATA_HORA_INI >= '01/09/2017' AND BLPROC_CIRURGICO.DATA_HORA_INI <= '30/09/2017'
group by faprocad.nome_pro, faespcad.descricao
ORDER BY 3 desc
