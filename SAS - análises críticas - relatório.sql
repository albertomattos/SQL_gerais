...
--Mudar data com o mês +1
(select case when n.next_update < '01/05/2018' then 'Desatualizado' else 'Atualizado' end from bsc_indicators n
where n.id = t.ref_source) atualizacao_indicador,
decode(t.classification,'0','Não classificado','1','Ótimo','2','Favorável','3','Regular','4',
'Desfavorável','5','Ruim','6','Crítico') Classificacao, t.info_current, t.info_reasons, t.info_tendence
...
and w.monitor = '1'
--Mudar data
and upper(t.title) like 'AC%ABRIL 2018%' order by 2,1
