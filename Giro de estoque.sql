SELECT 
ROUND((SUM(CUSTO_T) / SUM(TOTAL)),3) GIRO
...
FROM DUAL) AND FTC.TIPO_PRD IN ('EPI','ENX','FIO','FNU','EQU','ESP','OBR','MEX','MHL','MMA','DES','MEL','MAT','MED','SUT','GEN','ICC')
...
FROM DUAL)AND TIP.TIPO_PRD IN('EPI','ENX','FIO','FNU','EQU','ESP','OBR','MEX','MHL','MMA','DES','MEL','MAT','MED','SUT','GEN','ICC')
