...
select t.meta_tolerance, t.name, t.restriction, t.rowid from bsc_indicators t where upper(t.name) like '%PRESSÃ%'  and t.family = '0'
...
--Regressão linear (com: 2995, sem: 947)
